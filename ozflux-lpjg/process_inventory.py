...
def parse_args(opts: list[str]) -> Options:
    ...
    parser.add_argument("--date-infmt", default = "%d/%m/%Y", help = f"Format of dates in the input files")
    parser.add_argument("--date-fmt", default = "%Y-%m-%d", help = "Date format to be used in the output file")
